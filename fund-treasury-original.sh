...
echo "🚀 Funding SwitcherFi Treasury (Original Contract)..."
echo "====================================================="
...
# Create transaction to deposit SUI tokens to treasury
# Note: The original contract uses deposit_to_treasury function
sui client call \
  --package $PACKAGE_ID \
  --module swap \
  --function deposit_to_treasury \
  --args $TREASURY_ID $DEPOSIT_AMOUNT \
  --gas-budget 10000000
